...
public class AStarSolver extends AbstractSolver {
     ...
     * <ol>
     * <li>Будем работать с приоритетной очередью для множества узлов,
     * сортируемых по 'f' и хэш-мапой для их хранения.</li>
     * <li>Начнем с узла с координатами начальной точки и добавим его в нашу хэш-мапу.</li>
     * <li>До тех пор, пока наше множество не пустое:
     *     <ul>
     *     <li>Извлечем узел с наименьшим 'f', если он не является конечной координатой:</li>
     *     <li>Пройдемся по всем соседям:</li>
     *     <li>Создаем узлы соседей, если их 'g' меньше текущего,
     *     обновим его родителя и соответствующие значения 'g' и 'f'.</li>
     *     <li>Добавим соседа при его отсутствии в нашем множестве.</li>
     *     </ul>
     * </li>
     * <li>При совпадении текущей и конечной, вернем путь,
     * восстановив его от конечного узла до стартового (перевернув).</li>
     * </ol>
     */
    @Override
